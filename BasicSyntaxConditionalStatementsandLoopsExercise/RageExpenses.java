...
public class RageExpenses {
    public static void main(String[] args) {
        ...
        double expanses = headsetCount*headsetPrice+mouseCount*mousePrice+keyboardCount*keyboardPrice+displayCount*displayPrice;

        System.out.printf("Rage expenses: %.2f lv.", expanses);
    }
}
